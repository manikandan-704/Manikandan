  ...
  const projects = [
    {
      ...
      github: 'https://github.com/nagarajpriyan2004',
      color: 'from-blue-500 to-cyan-500',
    },
    {
      title: 'ADS MAIL',
      subtitle: 'Gmail-Inspired Web Application',
      description:
        'A feature-rich email application built from the ground up using core web technologies. Demonstrates mastery of full-stack development with modern architecture patterns and user-centric design principles.',
      features: [
        'Complete email management system (compose, send, receive)',
        'Real-time data synchronization with MongoDB',
        'Responsive design ensuring seamless cross-device experience',
        'Secure authentication and authorization',
        'Clean, maintainable code following MVC design pattern',
      ],
      techStack: [
        { name: 'React.js', icon: Code2 },
        { name: 'Node.js', icon: Server },
